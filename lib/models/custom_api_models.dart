class CustomEpisode {
  ...
  factory CustomEpisode.fromJson(Map<String, dynamic> json) {
    return CustomEpisode(
      title: json['title'] ?? '',
      number:
          num.tryParse((json['episodeNumber'] ?? json['number']).toString()) ??
              0,
...
class CustomStream {
  ...
  factory CustomStream.fromJson(Map<String, dynamic> json) {
    ...
    if (json['streams'] != null &&
        json['streams'] is List &&
        json['streams'].isNotEmpty) {
      parsedM3u8 = json['streams'][0]['url'] ?? '';
      parsedReferer = json['streams'][0]['referer'] ?? '';
    } else if (json['stream'] != null) {
      parsedM3u8 = json['stream']['m3u8'] ?? '';
    } else {
      parsedM3u8 = json['m3u8'] ?? '';
    }
